// https://github.com/gouravthakur39/beginners-C-program-examples/blob/master/last-digit-fibonacci.c
int last_digit_fib_optimized( int index)
{
	int first = 0; 
	int second = 1;
	int current = 0;
...
int last_digit_fib_naive( int index)
{
	int *arr;
